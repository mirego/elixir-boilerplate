...
- Translations with [Gettext](https://hexdocs.pm/gettext) and [Accent](https://www.accent.reviews) (using a automated GitHub Actions [workflow](./.github/workflows/accent.yaml))
